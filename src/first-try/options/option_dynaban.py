...
OPTIONS_DYNABAN = {'AdaptSigma': 'CMAAdaptSigmaCSA',  # or any other CMAAdaptSigmaBase class e.g. CMAAdaptSigmaTPA',
                    ...
                    'CMA_diagonal': 0*100*N/np.sqrt(popsize),  # nb of iterations with diagonal covariance matrix, True for always',
